...
export class BlockListComponent implements OnInit {
  ...
  DuradelTasks: TaskData[] = [
    ...
    {id: '3', name: 'Metal dragons', weight: 14},
  ...
  NieveTasks: TaskData[] = [
    ...
    {id: '76', name: 'Custodian stalker', weight: 8},
    {id: '15', name: 'Dagannoth', weight: 8},
    {id: '16', name: 'Dark beasts', weight: 5},
  ...
  ChaeldarTasks: TaskData[] = [
    {id: '1', name: 'Aberrant spectres', weight: 8},
    {id: '2', name: 'Abyssal Demon', weight: 12},
    {id: '5', name: 'Aviansies', weight: 9},
    {id: '6', name: 'Basilisks', weight: 7},
    {id: '7', name: 'Black demons', weight: 10},
    {id: '9', name: 'Bloodvelds', weight: 8},
    {id: '10', name: 'Blue dragons', weight: 8},
    {id: '12', name: 'Brine rats', weight: 7},
    {id: '13', name: 'Cave horrors', weight: 10},
    {id: '14', name: 'Cave kraken', weight: 12},
    {id: '77', name: 'Crabs', weight: 8},
    {id: '76', name: 'Custodian stalker', weight: 11},
    {id: '15', name: 'Dagannoth', weight: 11},
    {id: '18', name: 'Dust devils', weight: 9},
    {id: '19', name: 'Elves', weight: 8},
    {id: '78', name: 'Fever spiders', weight: 7},
    {id: '20', name: 'Fire giants', weight: 12},
    {id: '21', name: 'Fossil Island Wyverns', weight: 7},
    {id: '22', name: 'Gargoyles', weight: 11},
    {id: '23', name: 'Greater demons', weight: 9},
    {id: '24', name: 'Hellhounds', weight: 9},
    {id: '71', name: 'Jellies', weight: 10},
    {id: '79', name: 'Jungle horrors', weight: 10},
    {id: '26', name: 'Kalphites', weight: 11},
    {id: '27', name: 'Kurasks', weight: 12},
    {id: '61', name: 'Lesser demons', weight: 9},
    {id: '72', name: 'Lesser Nagua', weight: 4},
    {id: '28', name: 'Lizardmen', weight: 8},
    {id: '30', name: 'Mutated Zygomites', weight: 7},
    {id: '31', name: 'Nechryael', weight: 12},
    {id: '80', name: 'Shadow warriors', weight: 8},
    {id: '34', name: 'Skeletal wyverns', weight: 7},
    {id: '36', name: 'Spiritual creatures', weight: 12},
    {id: '39', name: 'Trolls', weight: 11},
    {id: '70', name: 'Turoth', weight: 10},
    {id: '74', name: 'TzHaar', weight: 8},
    {id: '41', name: 'Vampyres', weight: 6},
    {id: '42', name: 'Warped creatures', weight: 6},
    {id: '44', name: 'Wyrms', weight: 6}
  ];
